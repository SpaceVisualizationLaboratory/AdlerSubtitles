BYOD Captioning
===============
**This is the automatic version of the Bring Your Own Device captioning (where a show operator presses on button to start all the captions). If you are intrested in the manual version (where each user presses a button to start the captions), the repo can be found at https://github.com/Space Visualization Laboratory/AdlerSubtitlesManual This repo holds the official 'release' version of the software. @jsub1's development branch can be found here https://github.com/jsub1/AdlerSubtitles**
